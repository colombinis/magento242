...
--
-- Host: localhost    Database: magento_242
-- ------------------------------------------------------
...
INSERT INTO `admin_passwords` VALUES (1,1,'ae0a3455916be39d193b30536aae461087cdf58f8d7eae2723d66a7704717c56:SqXRktatkD8A1hmuKYNQpLRaUkechTgi:3_32_2_67108864',0,1633078918),(2,1,'e67d8995c649a03a81fbde0b4afb2c1ae47aa46b7fe8fa64c1251523d2c4acd0:8sWrIhhrYS1Cr0NlNYEIVY0F5Pt6ZdOv:3_32_2_67108864',0,1633079844);
...
INSERT INTO `admin_system_messages` VALUES ('c79237a69f9c7b43241a29075febea12',1,'2021-10-01 09:23:05'),('da332d712f3215b9b94bfa268c398323',2,'2021-10-01 09:21:14');
...
INSERT INTO `admin_user` VALUES (1,'seba','colo','sadmin@email.com','sadmin','e67d8995c649a03a81fbde0b4afb2c1ae47aa46b7fe8fa64c1251523d2c4acd0:8sWrIhhrYS1Cr0NlNYEIVY0F5Pt6ZdOv:3_32_2_67108864','2021-10-01 09:01:58','2021-10-08 22:48:21','2021-10-08 22:48:21',2,0,1,NULL,NULL,NULL,'en_US',0,NULL,NULL,NULL);
...
INSERT INTO `admin_user_session` VALUES (1,'6bbgm42ro207lmo4at3nh06b6n',1,1,'2021-10-01 09:20:20','2021-10-01 09:23:29','127.0.0.1'),(2,'6b43355pi2adrl25659hfjn969',1,1,'2021-10-08 22:48:21','2021-10-08 22:48:21','127.0.0.1');
...
INSERT INTO `authorization_role` VALUES (1,0,1,1,'G',0,'2','Administrators'),(2,1,2,0,'U',1,'2','sadmin');
...
INSERT INTO `catalog_category_entity` VALUES (1,3,0,'2021-10-01 09:01:52','2021-10-01 09:01:53','1',0,0,1),(2,3,1,'2021-10-01 09:01:53','2021-10-01 09:01:53','1/2',1,1,0);
...
IF (NOT(NEW.`item_id` <=> OLD.`item_id`) OR NOT(NEW.`product_id` <=> OLD.`product_id`) OR NOT(NEW.`stock_id` <=> OLD.`stock_id`) OR NOT(NEW.`qty` <=> OLD.`qty`) OR NOT(NEW.`min_qty` <=> OLD.`min_qty`) OR NOT(NEW.`use_config_min_qty` <=> OLD.`use_config_min_qty`) OR NOT(NEW.`is_qty_decimal` <=> OLD.`is_qty_decimal`) OR NOT(NEW.`backorders` <=> OLD.`backorders`) OR NOT(NEW.`use_config_backorders` <=> OLD.`use_config_backorders`) OR NOT(NEW.`min_sale_qty` <=> OLD.`min_sale_qty`) OR NOT(NEW.`use_config_min_sale_qty` <=> OLD.`use_config_min_sale_qty`) OR NOT(NEW.`max_sale_qty` <=> OLD.`max_sale_qty`) OR NOT(NEW.`use_config_max_sale_qty` <=> OLD.`use_config_max_sale_qty`) OR NOT(NEW.`is_in_stock` <=> OLD.`is_in_stock`) OR NOT(NEW.`low_stock_date` <=> OLD.`low_stock_date`) OR NOT(NEW.`notify_stock_qty` <=> OLD.`notify_stock_qty`) OR NOT(NEW.`use_config_notify_stock_qty` <=> OLD.`use_config_notify_stock_qty`) OR NOT(NEW.`manage_stock` <=> OLD.`manage_stock`) OR NOT(NEW.`use_config_manage_stock` <=> OLD.`use_config_manage_stock`) OR NOT(NEW.`stock_status_changed_auto` <=> OLD.`stock_status_changed_auto`) OR NOT(NEW.`use_config_qty_increments` <=> OLD.`use_config_qty_increments`) OR NOT(NEW.`qty_increments` <=> OLD.`qty_increments`) OR NOT(NEW.`use_config_enable_qty_inc` <=> OLD.`use_config_enable_qty_inc`) OR NOT(NEW.`enable_qty_increments` <=> OLD.`enable_qty_increments`) OR NOT(NEW.`is_decimal_divided` <=> OLD.`is_decimal_divided`) OR NOT(NEW.`website_id` <=> OLD.`website_id`)) THEN INSERT IGNORE INTO `catalog_product_price_cl` (`entity_id`) VALUES (NEW.`product_id`); END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_catalogrule_product_price_replica_after_insert` AFTER INSERT ON `catalogrule_product_price_replica` FOR EACH ROW BEGIN
INSERT IGNORE INTO `catalog_product_price_cl` (`entity_id`) VALUES (NEW.`product_id`);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_catalogrule_product_price_replica_after_update` AFTER UPDATE ON `catalogrule_product_price_replica` FOR EACH ROW BEGIN
IF (NOT(NEW.`rule_product_price_id` <=> OLD.`rule_product_price_id`) OR NOT(NEW.`rule_date` <=> OLD.`rule_date`) OR NOT(NEW.`customer_group_id` <=> OLD.`customer_group_id`) OR NOT(NEW.`product_id` <=> OLD.`product_id`) OR NOT(NEW.`rule_price` <=> OLD.`rule_price`) OR NOT(NEW.`website_id` <=> OLD.`website_id`) OR NOT(NEW.`latest_start_date` <=> OLD.`latest_start_date`) OR NOT(NEW.`earliest_end_date` <=> OLD.`earliest_end_date`)) THEN INSERT IGNORE INTO `catalog_product_price_cl` (`entity_id`) VALUES (NEW.`product_id`); END IF;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `trg_catalogrule_product_price_replica_after_delete` AFTER DELETE ON `catalogrule_product_price_replica` FOR EACH ROW BEGIN
INSERT IGNORE INTO `catalog_product_price_cl` (`entity_id`) VALUES (OLD.`product_id`);
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
) ENGINE=InnoDB AUTO_INCREMENT=28 DEFAULT CHARSET=utf8mb3 COMMENT='Config Data';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `core_config_data` VALUES (1,'default',0,'yotpo/module_info/yotpo_installation_date','2021-10-01','2021-10-01 09:00:34'),(2,'default',0,'yotpo/sync_settings/orders_sync_start_date','2021-10-01','2021-10-01 09:00:34'),(3,'default',0,'web/seo/use_rewrites','1','2021-10-01 09:01:46'),(4,'default',0,'web/unsecure/base_url','http://local.m242/','2021-10-01 09:01:47'),(5,'default',0,'general/locale/code','en_US','2021-10-01 09:01:47'),(6,'default',0,'general/locale/timezone','America/Chicago','2021-10-01 09:01:47'),(7,'default',0,'currency/options/base','USD','2021-10-01 09:01:47'),(8,'default',0,'currency/options/default','USD','2021-10-01 09:01:47'),(9,'default',0,'currency/options/allow','USD','2021-10-01 09:01:47'),(10,'default',0,'general/region/display_all','1','2021-10-01 09:01:48'),(11,'default',0,'general/region/state_required','AU,BG,BR,CA,CH,CN,CO,EE,ES,HR,IN,IT,LT,LV,MX,PL,RO,US,UY','2021-10-01 09:01:51'),(12,'default',0,'catalog/category/root_id','2','2021-10-01 09:01:53'),(13,'default',0,'analytics/subscription/enabled','1','2021-10-01 09:01:55'),(14,'default',0,'crontab/default/jobs/analytics_subscribe/schedule/cron_expr','0 * * * *','2021-10-01 09:01:55'),(15,'default',0,'crontab/default/jobs/analytics_collect_data/schedule/cron_expr','00 02 * * *','2021-10-01 09:01:55'),(16,'default',0,'msp_securitysuite_recaptcha/frontend/enabled','0','2021-10-01 09:01:56'),(17,'default',0,'msp_securitysuite_recaptcha/backend/enabled','0','2021-10-01 09:01:56'),(18,'default',0,'twofactorauth/duo/application_key','V3Uagra8DvElElj0fATzYzS0nEin79i5ZMmU2otYyfSkGV85L7os1Ze7umejcQYV','2021-10-01 09:01:56'),(19,'website',0,'connector_configuration/transactional_data/order_statuses','canceled,closed,complete,fraud,holded,payment_review,paypal_canceled_reversal,paypal_reversed,pending,pending_payment,pending_paypal,processing','2021-10-01 09:01:56'),(20,'website',0,'connector_configuration/catalog_sync/catalog_type','simple,virtual,bundle,downloadable,grouped,configurable','2021-10-01 09:01:56'),(21,'website',0,'connector_configuration/catalog_sync/catalog_visibility','1,2,3,4','2021-10-01 09:01:56'),(22,'default',0,'connector_dynamic_content/external_dynamic_content_urls/passcode','mhRM66WxeLBBkB0RdQEvE3rdllEY7I5d','2021-10-01 09:01:56'),(23,'default',0,'connector_automation/review_settings/allow_non_subscribers','1','2021-10-01 09:01:56'),(24,'default',0,'connector_configuration/abandoned_carts/allow_non_subscribers','1','2021-10-01 09:01:56'),(25,'default',0,'sync_settings/addressbook/allow_non_subscribers','1','2021-10-01 09:01:56'),(26,'default',0,'connector_developer_settings/system_alerts/user_roles','1','2021-10-01 09:01:56'),(27,'default',0,'admin/usage/enabled','0','2021-10-01 09:23:01');
...
INSERT INTO `flag` VALUES (1,'analytics_link_attempts_reverse_counter',0,'24','2021-10-01 09:01:55');
...
INSERT INTO `indexer_state` VALUES (1,'design_config_grid','valid','2021-10-01 09:04:17','1e8de74318e04c778b5019e36bc46c9f'),(2,'customer_grid','valid','2021-10-01 09:01:57','896a82b5b7f1caa7c6119abf0297b9db'),(3,'catalog_category_product','invalid','2021-10-01 09:01:52','e4d1a487d5c73ebafabe917725a6a5b5'),(4,'catalog_product_category','invalid','2021-10-01 09:01:52','c387a3967baecd5af1232b9c4d0ab12f'),(5,'catalogrule_rule','invalid','2021-10-01 09:01:52','7b7211044639c5173cc6b75d6ea5feec'),(6,'catalog_product_attribute','invalid','2021-10-01 09:01:52','b95f9c4625e99aa629a41956707284c8'),(7,'cataloginventory_stock','invalid','2021-10-01 09:01:52','002ad125ed494769d391f0e99db8bab5'),(8,'inventory','invalid','2021-10-01 09:01:52','c64519ad7f5e972c55b713293b87aec6'),(9,'catalogrule_product','invalid','2021-10-01 09:01:52','0cf7c8a673a4d83cd285b604ecd6427c'),(10,'catalog_product_price','invalid','2021-10-01 09:01:52','5d44098a6adc8ed5bb4766d71bd6945d'),(11,'catalogsearch_fulltext','invalid','2021-10-01 09:01:52','f42453bf13ef14d6720e27c41ca96789');
...
INSERT INTO `mview_state` VALUES (1,'design_config_dummy','enabled','idle','2021-10-01 09:23:29',NULL),(2,'customer_dummy','enabled','idle','2021-10-01 09:23:29',NULL),(3,'catalog_category_product','enabled','idle','2021-10-01 09:23:29',NULL),(4,'catalog_product_category','enabled','idle','2021-10-01 09:23:30',NULL),(5,'catalogrule_rule','enabled','idle','2021-10-01 09:23:30',NULL),(6,'catalog_product_attribute','enabled','idle','2021-10-01 09:23:30',NULL),(7,'cataloginventory_stock','enabled','idle','2021-10-01 09:23:30',NULL),(8,'inventory','enabled','idle','2021-10-01 09:23:30',NULL),(9,'catalogrule_product','enabled','idle','2021-10-01 09:23:31',NULL),(10,'catalog_product_price','enabled','idle','2021-10-01 09:23:32',NULL),(11,'catalogsearch_fulltext','enabled','idle','2021-10-01 09:23:33',NULL);
...
INSERT INTO `queue_poison_pill` VALUES ('version-6156d37599fe2');
...
INSERT INTO `theme` VALUES (1,NULL,'Magento/blank','Magento Blank','preview_image_6156ce7f6870e.jpeg',0,'frontend',0,'Magento/blank'),(2,1,'Magento/luma','Magento Luma','preview_image_6156ce7f78a4e.jpeg',0,'frontend',0,'Magento/luma'),(3,NULL,'Magento/backend','Magento 2 backend',NULL,0,'adminhtml',0,'Magento/backend');
...
-- Dump completed on 2021-10-08 19:49:26
